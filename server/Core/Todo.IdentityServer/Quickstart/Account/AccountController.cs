...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var info = await HttpContext.Authentication.GetAuthenticateInfoAsync("Identity.External");
            ...
            if (user == null)
            {
                user = new IdentityUser { UserName = tempUser.FindFirstValue(ClaimTypes.Email) ?? tempUser.FindFirstValue(JwtClaimTypes.Email) };
            ...
            var givenName = tempUser.FindFirstValue(ClaimTypes.GivenName);
            if (givenName != null)
            {
                additionalClaims.Add(new Claim(JwtClaimTypes.GivenName, givenName));
            }

            var familyName = tempUser.FindFirstValue(ClaimTypes.Surname);
            if (familyName != null)
            {
                additionalClaims.Add(new Claim(JwtClaimTypes.FamilyName, familyName));
            }
